...
const HeroPhases = () => {
  return (
    <div className="w-full h-screen flex items-center justify-center">
      ...
      >
        <h2 className="text-white text-center text-2xl sm:text-4xl md:text-6xl font-semibold mt-15 leading-snug px-4">
          Discover the Network and Be Part of the Community
        </h2>
        <h3 className="text-white text-xl sm:text-2xl font-semibold">I-Nexus Community</h3>
